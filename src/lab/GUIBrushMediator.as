package lab
{
	 ...
	 * @author Duc-Tri
	 */
	public class GUIBrushMediator
	{
		public static var instance:GUIBrushMediator;
		private static var brushMInstance:BrushManager;
		private static var guiMInstance:GUIManager;
		private static var m_stage:Stage;
		
		public function GUIBrushMediator(s:SingletonEnforcer)
		{
		...
		public static function getInstance(_s:Stage):GUIBrushMediator
		{
			if (!instance)
			{
				m_stage = _s;
				instance = new GUIBrushMediator(new SingletonEnforcer());
			}
